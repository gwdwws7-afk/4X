...
- Batch: `R3-05-B002-R306-V03`
- Profile: `r296-variance-compress-d-validation`
- Runs: `1000`
- Source CSV: `C:\test\4X\production\evidence\r3\validation\20260423_R3-05_VALIDATION-R306-V03.csv`
- KPI Pass: `12/13`
...
| AVG_END_TURN_STANDARD | 15.8825 | [15.0000, 19.0000] | PASS |
| ATTRITION_RATE_OVERALL | 0.2010 | [0.1000, 0.3500] | PASS |
| RESOURCE_CV_GOLDLEAF | 0.4153 | [0.1800, 0.4500] | PASS |
...
- Top victory path: `energyliberation` (`284` wins, share `0.6469`)
