...
- Batch: `R3-05-B002-R320-V03`
- Profile: `r318-late-convert-timeout-b-validation`
- Runs: `1000`
- Source CSV: `C:\test\4X\production\evidence\r3\validation\20260423_R3-05_VALIDATION-R320-V03.csv`
- KPI Pass: `11/13`
...
| RESOURCE_CV_GOLDLEAF | 0.4111 | [0.1800, 0.4500] | PASS |
| RESOURCE_CV_FIREOIL | 0.1862 | [0.1500, 0.4000] | PASS |
| RESOURCE_CV_ARMS | 0.2803 | [0.2000, 0.5500] | PASS |
...
- Top victory path: `energyliberation` (`271` wins, share `0.6216`)
