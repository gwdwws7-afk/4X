...
- Batch: `R3-05-B002-R201-V03`
- Profile: `r198-hard-survival-c-validation`
- Runs: `1000`
- Source CSV: `C:\test\4X\production\evidence\r3\validation\20260422_R3-05_VALIDATION-R201-V03.csv`
- KPI Pass: `12/13`
...
| AVG_END_TURN_STANDARD | 15.6525 | [15.0000, 19.0000] | PASS |
| ATTRITION_RATE_OVERALL | 0.1820 | [0.1000, 0.3500] | PASS |
| RESOURCE_CV_GOLDLEAF | 0.4226 | [0.1800, 0.4500] | PASS |
...
| SINGLE_PATH_VICTORY_MONOPOLY | 0.6292 | [0.0000, 0.7000] | PASS |
...
- Top victory path: `energyliberation` (`280` wins, share `0.6292`)
