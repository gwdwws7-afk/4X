...
- Batch: `R3-05-B002-R295-V03`
- Profile: `r287-standard-recover-f-validation`
- Runs: `1000`
- Source CSV: `C:\test\4X\production\evidence\r3\validation\20260423_R3-05_VALIDATION-R295-V03.csv`
- KPI Pass: `13/13`
...
| AVG_END_TURN_STANDARD | 15.5700 | [15.0000, 19.0000] | PASS |
...
| RESOURCE_CV_ARMS | 0.2827 | [0.2000, 0.5500] | PASS |
| VICTORY_SHARE_OVERALL | 0.4500 | [0.3500, 0.6500] | PASS |
| DEFEAT_SHARE_OVERALL | 0.3690 | [0.3500, 0.6500] | PASS |
| SINGLE_PATH_VICTORY_MONOPOLY | 0.6156 | [0.0000, 0.7000] | PASS |
...
- Top victory path: `energyliberation` (`277` wins, share `0.6156`)
