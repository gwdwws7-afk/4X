...
- Batch: `R3-05-B002-R204-V03`
- Profile: `r201-stability-close-c-validation`
- Runs: `1000`
- Source CSV: `C:\test\4X\production\evidence\r3\validation\20260423_R3-05_VALIDATION-R204-V03.csv`
- KPI Pass: `11/13`
...
| AVG_END_TURN_STANDARD | 16.0400 | [15.0000, 19.0000] | PASS |
| ATTRITION_RATE_OVERALL | 0.2080 | [0.1000, 0.3500] | PASS |
| RESOURCE_CV_GOLDLEAF | 0.4140 | [0.1800, 0.4500] | PASS |
| RESOURCE_CV_FIREOIL | 0.1780 | [0.1500, 0.4000] | PASS |
...
| SINGLE_PATH_VICTORY_MONOPOLY | 0.6697 | [0.0000, 0.7000] | PASS |
...
- Top victory path: `energyliberation` (`294` wins, share `0.6697`)
