...
- Batch: `R3-05-B002-R154-V03`
- Profile: `r151-r305-gap-close-a-validation`
- Runs: `1000`
- Source CSV: `C:\test\4X\production\evidence\r3\validation\20260422_R3-05_VALIDATION-R154-V03.csv`
- KPI Pass: `12/13`
...
| RESOURCE_CV_ARMS | 0.2791 | [0.2000, 0.5500] | PASS |
| VICTORY_SHARE_OVERALL | 0.4350 | [0.3500, 0.6500] | PASS |
| DEFEAT_SHARE_OVERALL | 0.3560 | [0.3500, 0.6500] | PASS |
| SINGLE_PATH_VICTORY_MONOPOLY | 0.6529 | [0.0000, 0.7000] | PASS |
...
- Top victory path: `energyliberation` (`284` wins, share `0.6529`)
