...
- Batch: `R3-05-B002-R85-V02`
- Profile: `r82-gate-stability-a-validation`
- Runs: `1000`
- Source CSV: `C:\test\4X\production\evidence\r3\validation\20260421_R3-05_VALIDATION-R85-V02.csv`
- KPI Pass: `10/13`
...
| AVG_END_TURN_STANDARD | 15.9525 | [15.0000, 19.0000] | PASS |
| ATTRITION_RATE_OVERALL | 0.2110 | [0.1000, 0.3500] | PASS |
| RESOURCE_CV_GOLDLEAF | 0.3674 | [0.1800, 0.4500] | PASS |
| RESOURCE_CV_FIREOIL | 0.1860 | [0.1500, 0.4000] | PASS |
| RESOURCE_CV_ARMS | 0.2564 | [0.2000, 0.5500] | PASS |
...
- Top victory path: `energyliberation` (`297` wins, share `0.6659`)
