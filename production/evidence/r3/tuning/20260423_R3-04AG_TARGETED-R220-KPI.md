# R3-04 KPI Evaluation (R220)

- Batch: `R3-04AG-B002-R220`
- Profile: `r212-hard-defeat-balance-a`
- Runs: `1000`
- Source CSV: `C:\test\4X\production\evidence\r3\tuning\20260423_R3-04AG_TARGETED-R220.csv`
- KPI Pass: `12/13`
...
| RESOURCE_CV_GOLDLEAF | 0.3957 | [0.1800, 0.4500] | PASS |
| RESOURCE_CV_FIREOIL | 0.1543 | [0.1500, 0.4000] | PASS |
| RESOURCE_CV_ARMS | 0.2127 | [0.2000, 0.5500] | PASS |
| VICTORY_SHARE_OVERALL | 0.4600 | [0.3500, 0.6500] | PASS |
| DEFEAT_SHARE_OVERALL | 0.3440 | [0.3500, 0.6500] | FAIL |
| SINGLE_PATH_VICTORY_MONOPOLY | 0.6065 | [0.0000, 0.7000] | PASS |
...
- Top victory path: `energyliberation` (`279` wins, share `0.6065`)
