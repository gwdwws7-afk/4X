# R3-04 KPI Evaluation (R261)

- Batch: `R3-04AG-B008-R261`
- Profile: `r201-stability-dual-gap-b`
- Runs: `1000`
- Source CSV: `C:\test\4X\production\evidence\r3\tuning\20260423_R3-04AG_TARGETED-R261.csv`
- KPI Pass: `12/13`
...
| AVG_END_TURN_OVERALL | 14.1390 | [14.0000, 20.0000] | PASS |
| AVG_END_TURN_STANDARD | 15.1900 | [15.0000, 19.0000] | PASS |
...
| RESOURCE_CV_ARMS | 0.2737 | [0.2000, 0.5500] | PASS |
| VICTORY_SHARE_OVERALL | 0.4560 | [0.3500, 0.6500] | PASS |
| DEFEAT_SHARE_OVERALL | 0.3700 | [0.3500, 0.6500] | PASS |
| SINGLE_PATH_VICTORY_MONOPOLY | 0.6316 | [0.0000, 0.7000] | PASS |
...
- Top victory path: `energyliberation` (`288` wins, share `0.6316`)
