# R3-04 KPI Evaluation (R202)

- Batch: `R3-04AC-B001-R202`
- Profile: `r201-stability-close-a`
- Runs: `1000`
- Source CSV: `C:\test\4X\production\evidence\r3\tuning\20260423_R3-04AC_TARGETED-R202.csv`
- KPI Pass: `11/13`
...
| AVG_END_TURN_OVERALL | 14.3980 | [14.0000, 20.0000] | PASS |
| AVG_END_TURN_STANDARD | 15.7125 | [15.0000, 19.0000] | PASS |
| ATTRITION_RATE_OVERALL | 0.1930 | [0.1000, 0.3500] | PASS |
| RESOURCE_CV_GOLDLEAF | 0.4287 | [0.1800, 0.4500] | PASS |
...
- Top victory path: `energyliberation` (`288` wins, share `0.6429`)
