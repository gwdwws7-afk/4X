# R3-04 KPI Evaluation (R247)

- Batch: `R3-04AG-B006-R247`
- Profile: `r230-easy-threshold-fine-d`
- Runs: `1000`
- Source CSV: `C:\test\4X\production\evidence\r3\tuning\20260423_R3-04AG_TARGETED-R247.csv`
- KPI Pass: `12/13`
...
| AVG_END_TURN_OVERALL | 14.1020 | [14.0000, 20.0000] | PASS |
...
| RESOURCE_CV_ARMS | 0.2300 | [0.2000, 0.5500] | PASS |
| VICTORY_SHARE_OVERALL | 0.4410 | [0.3500, 0.6500] | PASS |
| DEFEAT_SHARE_OVERALL | 0.3530 | [0.3500, 0.6500] | PASS |
| SINGLE_PATH_VICTORY_MONOPOLY | 0.6236 | [0.0000, 0.7000] | PASS |
...
- Top victory path: `energyliberation` (`275` wins, share `0.6236`)
