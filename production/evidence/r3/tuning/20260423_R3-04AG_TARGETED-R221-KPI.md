# R3-04 KPI Evaluation (R221)

- Batch: `R3-04AG-B002-R221`
- Profile: `r212-hard-defeat-balance-b`
- Runs: `1000`
- Source CSV: `C:\test\4X\production\evidence\r3\tuning\20260423_R3-04AG_TARGETED-R221.csv`
- KPI Pass: `12/13`
...
| AVG_END_TURN_OVERALL | 14.1100 | [14.0000, 20.0000] | PASS |
| AVG_END_TURN_STANDARD | 15.8225 | [15.0000, 19.0000] | PASS |
| ATTRITION_RATE_OVERALL | 0.1950 | [0.1000, 0.3500] | PASS |
| RESOURCE_CV_GOLDLEAF | 0.3932 | [0.1800, 0.4500] | PASS |
| RESOURCE_CV_FIREOIL | 0.1537 | [0.1500, 0.4000] | PASS |
| RESOURCE_CV_ARMS | 0.2116 | [0.2000, 0.5500] | PASS |
| VICTORY_SHARE_OVERALL | 0.4580 | [0.3500, 0.6500] | PASS |
| DEFEAT_SHARE_OVERALL | 0.3470 | [0.3500, 0.6500] | FAIL |
| SINGLE_PATH_VICTORY_MONOPOLY | 0.6048 | [0.0000, 0.7000] | PASS |
...
- Top victory path: `energyliberation` (`277` wins, share `0.6048`)
