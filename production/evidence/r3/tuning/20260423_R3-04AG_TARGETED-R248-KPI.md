# R3-04 KPI Evaluation (R248)

- Batch: `R3-04AG-B006-R248`
- Profile: `r230-easy-threshold-fine-e`
- Runs: `1000`
- Source CSV: `C:\test\4X\production\evidence\r3\tuning\20260423_R3-04AG_TARGETED-R248.csv`
- KPI Pass: `12/13`
...
| AVG_END_TURN_OVERALL | 14.1630 | [14.0000, 20.0000] | PASS |
| AVG_END_TURN_STANDARD | 15.4200 | [15.0000, 19.0000] | PASS |
| ATTRITION_RATE_OVERALL | 0.2080 | [0.1000, 0.3500] | PASS |
| RESOURCE_CV_GOLDLEAF | 0.4084 | [0.1800, 0.4500] | PASS |
| RESOURCE_CV_FIREOIL | 0.1650 | [0.1500, 0.4000] | PASS |
| RESOURCE_CV_ARMS | 0.2294 | [0.2000, 0.5500] | PASS |
| VICTORY_SHARE_OVERALL | 0.4360 | [0.3500, 0.6500] | PASS |
| DEFEAT_SHARE_OVERALL | 0.3560 | [0.3500, 0.6500] | PASS |
| SINGLE_PATH_VICTORY_MONOPOLY | 0.6284 | [0.0000, 0.7000] | PASS |
...
- Top victory path: `energyliberation` (`274` wins, share `0.6284`)
