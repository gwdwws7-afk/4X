# R3-04 KPI Evaluation (R203)

- Batch: `R3-04AC-B001-R203`
- Profile: `r201-stability-close-b`
- Runs: `1000`
- Source CSV: `C:\test\4X\production\evidence\r3\tuning\20260423_R3-04AC_TARGETED-R203.csv`
- KPI Pass: `12/13`
...
- Shock: `chance=0.33`, `magnitude=+/-26`
...
|---|---:|---:|---|
| WIN_RATE_EASY | 0.7467 | [0.6500, 0.8000] | PASS |
...
| AVG_END_TURN_OVERALL | 14.1160 | [14.0000, 20.0000] | PASS |
| AVG_END_TURN_STANDARD | 15.4875 | [15.0000, 19.0000] | PASS |
| ATTRITION_RATE_OVERALL | 0.1800 | [0.1000, 0.3500] | PASS |
| RESOURCE_CV_GOLDLEAF | 0.4152 | [0.1800, 0.4500] | PASS |
| RESOURCE_CV_FIREOIL | 0.1735 | [0.1500, 0.4000] | PASS |
| RESOURCE_CV_ARMS | 0.2316 | [0.2000, 0.5500] | PASS |
| VICTORY_SHARE_OVERALL | 0.4730 | [0.3500, 0.6500] | PASS |
| DEFEAT_SHARE_OVERALL | 0.3470 | [0.3500, 0.6500] | FAIL |
| SINGLE_PATH_VICTORY_MONOPOLY | 0.6364 | [0.0000, 0.7000] | PASS |
...
- Top victory path: `energyliberation` (`301` wins, share `0.6364`)
