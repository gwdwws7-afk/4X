# R3-04 KPI Evaluation (R267)

- Batch: `R3-04AG-B009-R267`
- Profile: `r262-dual-gap-closure-b`
- Runs: `1000`
- Source CSV: `C:\test\4X\production\evidence\r3\tuning\20260423_R3-04AG_TARGETED-R267.csv`
- KPI Pass: `12/13`
...
- Late Escalation: `startTurn=14`, `pressure+=0.094`, `conflict+=0.067`, `loss+=0.114`, `capture-=0.038`
...
| AVG_END_TURN_OVERALL | 14.1670 | [14.0000, 20.0000] | PASS |
| AVG_END_TURN_STANDARD | 15.2575 | [15.0000, 19.0000] | PASS |
| ATTRITION_RATE_OVERALL | 0.1750 | [0.1000, 0.3500] | PASS |
| RESOURCE_CV_GOLDLEAF | 0.4377 | [0.1800, 0.4500] | PASS |
| RESOURCE_CV_FIREOIL | 0.2000 | [0.1500, 0.4000] | PASS |
...
| SINGLE_PATH_VICTORY_MONOPOLY | 0.6324 | [0.0000, 0.7000] | PASS |
...
- Top victory path: `energyliberation` (`289` wins, share `0.6324`)
