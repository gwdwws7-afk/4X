# R3-04 KPI Evaluation (R281)

- Batch: `R3-04AG-B011-R281`
- Profile: `r276-defeat-lift-d`
- Runs: `1000`
- Source CSV: `C:\test\4X\production\evidence\r3\tuning\20260423_R3-04AG_TARGETED-R281.csv`
- KPI Pass: `13/13`
...
| AVG_END_TURN_OVERALL | 14.1200 | [14.0000, 20.0000] | PASS |
| AVG_END_TURN_STANDARD | 15.0450 | [15.0000, 19.0000] | PASS |
| ATTRITION_RATE_OVERALL | 0.1720 | [0.1000, 0.3500] | PASS |
| RESOURCE_CV_GOLDLEAF | 0.4348 | [0.1800, 0.4500] | PASS |
| RESOURCE_CV_FIREOIL | 0.1993 | [0.1500, 0.4000] | PASS |
...
| SINGLE_PATH_VICTORY_MONOPOLY | 0.6293 | [0.0000, 0.7000] | PASS |
...
- Top victory path: `energyliberation` (`292` wins, share `0.6293`)
