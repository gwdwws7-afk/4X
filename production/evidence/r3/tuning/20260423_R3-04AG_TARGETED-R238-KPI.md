# R3-04 KPI Evaluation (R238)

- Batch: `R3-04AG-B005-R238`
- Profile: `r230-easy-turnlift-a`
- Runs: `1000`
- Source CSV: `C:\test\4X\production\evidence\r3\tuning\20260423_R3-04AG_TARGETED-R238.csv`
- KPI Pass: `12/13`
...
| AVG_END_TURN_OVERALL | 14.2550 | [14.0000, 20.0000] | PASS |
| AVG_END_TURN_STANDARD | 15.4200 | [15.0000, 19.0000] | PASS |
| ATTRITION_RATE_OVERALL | 0.2150 | [0.1000, 0.3500] | PASS |
| RESOURCE_CV_GOLDLEAF | 0.4068 | [0.1800, 0.4500] | PASS |
| RESOURCE_CV_FIREOIL | 0.1659 | [0.1500, 0.4000] | PASS |
| RESOURCE_CV_ARMS | 0.2314 | [0.2000, 0.5500] | PASS |
| VICTORY_SHARE_OVERALL | 0.4290 | [0.3500, 0.6500] | PASS |
| DEFEAT_SHARE_OVERALL | 0.3560 | [0.3500, 0.6500] | PASS |
| SINGLE_PATH_VICTORY_MONOPOLY | 0.6340 | [0.0000, 0.7000] | PASS |
...
- Top victory path: `energyliberation` (`272` wins, share `0.6340`)
