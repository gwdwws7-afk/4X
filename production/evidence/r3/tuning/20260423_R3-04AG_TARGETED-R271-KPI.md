# R3-04 KPI Evaluation (R271)

- Batch: `R3-04AG-B009-R271`
- Profile: `r262-dual-gap-closure-f`
- Runs: `1000`
- Source CSV: `C:\test\4X\production\evidence\r3\tuning\20260423_R3-04AG_TARGETED-R271.csv`
- KPI Pass: `12/13`
...
- Late Escalation: `startTurn=14`, `pressure+=0.094`, `conflict+=0.068`, `loss+=0.114`, `capture-=0.038`
...
| RESOURCE_CV_GOLDLEAF | 0.4337 | [0.1800, 0.4500] | PASS |
| RESOURCE_CV_FIREOIL | 0.2062 | [0.1500, 0.4000] | PASS |
| RESOURCE_CV_ARMS | 0.2871 | [0.2000, 0.5500] | PASS |
| VICTORY_SHARE_OVERALL | 0.4480 | [0.3500, 0.6500] | PASS |
| DEFEAT_SHARE_OVERALL | 0.3740 | [0.3500, 0.6500] | PASS |
| SINGLE_PATH_VICTORY_MONOPOLY | 0.6205 | [0.0000, 0.7000] | PASS |
...
- Top victory path: `energyliberation` (`278` wins, share `0.6205`)
