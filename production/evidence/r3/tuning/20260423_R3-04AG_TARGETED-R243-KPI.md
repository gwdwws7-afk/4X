# R3-04 KPI Evaluation (R243)

- Batch: `R3-04AG-B005-R243`
- Profile: `r230-easy-turnlift-f`
- Runs: `1000`
- Source CSV: `C:\test\4X\production\evidence\r3\tuning\20260423_R3-04AG_TARGETED-R243.csv`
- KPI Pass: `12/13`
...
|---|---:|---:|---|
| WIN_RATE_EASY | 0.5833 | [0.6500, 0.8000] | FAIL |
| WIN_RATE_STANDARD | 0.4600 | [0.4500, 0.5500] | PASS |
| WIN_RATE_HARD | 0.2167 | [0.2000, 0.3500] | PASS |
| WIN_RATE_OVERALL | 0.4240 | [0.4000, 0.6000] | PASS |
| AVG_END_TURN_OVERALL | 14.3070 | [14.0000, 20.0000] | PASS |
| AVG_END_TURN_STANDARD | 15.4200 | [15.0000, 19.0000] | PASS |
| ATTRITION_RATE_OVERALL | 0.2200 | [0.1000, 0.3500] | PASS |
| RESOURCE_CV_GOLDLEAF | 0.4083 | [0.1800, 0.4500] | PASS |
| RESOURCE_CV_FIREOIL | 0.1662 | [0.1500, 0.4000] | PASS |
| RESOURCE_CV_ARMS | 0.2309 | [0.2000, 0.5500] | PASS |
| VICTORY_SHARE_OVERALL | 0.4240 | [0.3500, 0.6500] | PASS |
...
- Top victory path: `energyliberation` (`269` wins, share `0.6344`)
