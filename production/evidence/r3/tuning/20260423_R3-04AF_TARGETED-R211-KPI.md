# R3-04 KPI Evaluation (R211)

- Batch: `R3-04AF-B001-R211`
- Profile: `r208-hard-timeout-convert-a`
- Runs: `1000`
- Source CSV: `C:\test\4X\production\evidence\r3\tuning\20260423_R3-04AF_TARGETED-R211.csv`
- KPI Pass: `12/13`
...
| AVG_END_TURN_OVERALL | 14.5510 | [14.0000, 20.0000] | PASS |
...
| RESOURCE_CV_FIREOIL | 0.1600 | [0.1500, 0.4000] | PASS |
| RESOURCE_CV_ARMS | 0.2179 | [0.2000, 0.5500] | PASS |
| VICTORY_SHARE_OVERALL | 0.4520 | [0.3500, 0.6500] | PASS |
| DEFEAT_SHARE_OVERALL | 0.3520 | [0.3500, 0.6500] | PASS |
| SINGLE_PATH_VICTORY_MONOPOLY | 0.6173 | [0.0000, 0.7000] | PASS |
...
- Top victory path: `energyliberation` (`279` wins, share `0.6173`)
