# R3-04 KPI Evaluation (R293)

- Batch: `R3-04AG-B013-R293`
- Profile: `r287-standard-recover-d`
- Runs: `1000`
- Source CSV: `C:\test\4X\production\evidence\r3\tuning\20260423_R3-04AG_TARGETED-R293.csv`
- KPI Pass: `13/13`
...
| AVG_END_TURN_OVERALL | 14.2670 | [14.0000, 20.0000] | PASS |
| AVG_END_TURN_STANDARD | 15.1650 | [15.0000, 19.0000] | PASS |
| ATTRITION_RATE_OVERALL | 0.1790 | [0.1000, 0.3500] | PASS |
| RESOURCE_CV_GOLDLEAF | 0.4374 | [0.1800, 0.4500] | PASS |
| RESOURCE_CV_FIREOIL | 0.1999 | [0.1500, 0.4000] | PASS |
...
| SINGLE_PATH_VICTORY_MONOPOLY | 0.6223 | [0.0000, 0.7000] | PASS |
...
- Top victory path: `energyliberation` (`290` wins, share `0.6223`)
