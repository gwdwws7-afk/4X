# R3-04 KPI Evaluation (R249)

- Batch: `R3-04AG-B006-R249`
- Profile: `r230-easy-threshold-fine-f`
- Runs: `1000`
- Source CSV: `C:\test\4X\production\evidence\r3\tuning\20260423_R3-04AG_TARGETED-R249.csv`
- KPI Pass: `12/13`
...
| RESOURCE_CV_GOLDLEAF | 0.4054 | [0.1800, 0.4500] | PASS |
| RESOURCE_CV_FIREOIL | 0.1648 | [0.1500, 0.4000] | PASS |
| RESOURCE_CV_ARMS | 0.2295 | [0.2000, 0.5500] | PASS |
| VICTORY_SHARE_OVERALL | 0.4400 | [0.3500, 0.6500] | PASS |
| DEFEAT_SHARE_OVERALL | 0.3530 | [0.3500, 0.6500] | PASS |
| SINGLE_PATH_VICTORY_MONOPOLY | 0.6227 | [0.0000, 0.7000] | PASS |
...
- Top victory path: `energyliberation` (`274` wins, share `0.6227`)
