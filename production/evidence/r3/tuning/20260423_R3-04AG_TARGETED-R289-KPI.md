# R3-04 KPI Evaluation (R289)

- Batch: `R3-04AG-B012-R289`
- Profile: `r276-hard-compensated-pressure-f`
- Runs: `1000`
- Source CSV: `C:\test\4X\production\evidence\r3\tuning\20260423_R3-04AG_TARGETED-R289.csv`
- KPI Pass: `12/13`
...
- Late Escalation: `startTurn=13`, `pressure+=0.094`, `conflict+=0.072`, `loss+=0.125`, `capture-=0.040`
...
| AVG_END_TURN_OVERALL | 14.2370 | [14.0000, 20.0000] | PASS |
| AVG_END_TURN_STANDARD | 15.1925 | [15.0000, 19.0000] | PASS |
| ATTRITION_RATE_OVERALL | 0.1760 | [0.1000, 0.3500] | PASS |
| RESOURCE_CV_GOLDLEAF | 0.4400 | [0.1800, 0.4500] | PASS |
...
| SINGLE_PATH_VICTORY_MONOPOLY | 0.6250 | [0.0000, 0.7000] | PASS |
...
- Top victory path: `energyliberation` (`290` wins, share `0.6250`)
