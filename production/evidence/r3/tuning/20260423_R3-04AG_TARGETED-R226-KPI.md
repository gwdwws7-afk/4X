# R3-04 KPI Evaluation (R226)

- Batch: `R3-04AG-B003-R226`
- Profile: `r212-stability-balance-a`
- Runs: `1000`
- Source CSV: `C:\test\4X\production\evidence\r3\tuning\20260423_R3-04AG_TARGETED-R226.csv`
- KPI Pass: `11/13`
...
| RESOURCE_CV_GOLDLEAF | 0.3951 | [0.1800, 0.4500] | PASS |
| RESOURCE_CV_FIREOIL | 0.1627 | [0.1500, 0.4000] | PASS |
| RESOURCE_CV_ARMS | 0.2273 | [0.2000, 0.5500] | PASS |
| VICTORY_SHARE_OVERALL | 0.4750 | [0.3500, 0.6500] | PASS |
| DEFEAT_SHARE_OVERALL | 0.3450 | [0.3500, 0.6500] | FAIL |
| SINGLE_PATH_VICTORY_MONOPOLY | 0.6189 | [0.0000, 0.7000] | PASS |
...
- Top victory path: `energyliberation` (`294` wins, share `0.6189`)
