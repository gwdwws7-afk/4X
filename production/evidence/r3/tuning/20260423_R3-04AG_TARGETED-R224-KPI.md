# R3-04 KPI Evaluation (R224)

- Batch: `R3-04AG-B002-R224`
- Profile: `r212-hard-defeat-balance-e`
- Runs: `1000`
- Source CSV: `C:\test\4X\production\evidence\r3\tuning\20260423_R3-04AG_TARGETED-R224.csv`
- KPI Pass: `13/13`
...
| RESOURCE_CV_GOLDLEAF | 0.3878 | [0.1800, 0.4500] | PASS |
| RESOURCE_CV_FIREOIL | 0.1525 | [0.1500, 0.4000] | PASS |
| RESOURCE_CV_ARMS | 0.2107 | [0.2000, 0.5500] | PASS |
| VICTORY_SHARE_OVERALL | 0.4540 | [0.3500, 0.6500] | PASS |
| DEFEAT_SHARE_OVERALL | 0.3510 | [0.3500, 0.6500] | PASS |
| SINGLE_PATH_VICTORY_MONOPOLY | 0.6101 | [0.0000, 0.7000] | PASS |
...
- Top victory path: `energyliberation` (`277` wins, share `0.6101`)
