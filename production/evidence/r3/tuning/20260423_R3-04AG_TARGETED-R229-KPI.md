# R3-04 KPI Evaluation (R229)

- Batch: `R3-04AG-B003-R229`
- Profile: `r212-stability-balance-d`
- Runs: `1000`
- Source CSV: `C:\test\4X\production\evidence\r3\tuning\20260423_R3-04AG_TARGETED-R229.csv`
- KPI Pass: `11/13`
...
| AVG_END_TURN_OVERALL | 13.7330 | [14.0000, 20.0000] | FAIL |
| AVG_END_TURN_STANDARD | 15.4450 | [15.0000, 19.0000] | PASS |
| ATTRITION_RATE_OVERALL | 0.1810 | [0.1000, 0.3500] | PASS |
| RESOURCE_CV_GOLDLEAF | 0.3959 | [0.1800, 0.4500] | PASS |
| RESOURCE_CV_FIREOIL | 0.1626 | [0.1500, 0.4000] | PASS |
| RESOURCE_CV_ARMS | 0.2271 | [0.2000, 0.5500] | PASS |
| VICTORY_SHARE_OVERALL | 0.4740 | [0.3500, 0.6500] | PASS |
| DEFEAT_SHARE_OVERALL | 0.3450 | [0.3500, 0.6500] | FAIL |
| SINGLE_PATH_VICTORY_MONOPOLY | 0.6181 | [0.0000, 0.7000] | PASS |
...
- Top victory path: `energyliberation` (`293` wins, share `0.6181`)
